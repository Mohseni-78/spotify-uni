...
const Body = ({ chooseTrack, spotifyApi }) => {
    ...
    return (
        <section className="bg-black ml-24 py-4 space-y-8 md:max-w-[950px] flex-grow md:mr-2.5">
            ...
            <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
                ...
                <div className="w-full pr-11">
                    ...
                    <div className="space-y-3 border-2 border-[#262626] rounded-2xl p-3 bg-[#0D0D0D] overflow-hidden h-[1000px] md:h-96 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-thumb-rounded hover:scrollbar-thumb-gray-500 w-[700px]">
                        {searchResults.length === 0
                            ? newReleases
